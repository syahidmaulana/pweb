...
<body>
	...
	<br>
		<h1>Master Data User Perpustakaan</h1>
				...
				<table class="table table-striped table-hover dtabel">
					...
					<tbody> 
						...
						<tr>
							...
							<td>
								<a href="edit_data_user.php?id=<?php echo $row['id_user'];?>" class="btn btn-success" role="button">Edit</a>
								<a href="hapus_data_user.php?id=<?php echo $row['id_user']?>" class="btn btn-danger" role="button">Delete</a>
							</td>
						</tr>
